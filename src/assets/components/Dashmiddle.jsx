...
import pl from "../../Images/image.jpeg";
      ...
      <div>
        <div className="font-pop">
          <div className="p-8 font-pop  min-h-screen">
            ...
            <div className="grid gap-4 auto-rows-min  sm:grid-cols-12">
              ...
              <div className="bg-dgry p-6 rounded-lg shadow-md mb-6 flex flex-col  sm:col-span-6  gap-4">
                ...
                <div className="flex-1">
                  ...
                  <ul className="list-disc list-inside text-xs text-gray-200 text-justify">
            ...
            <h1 className="text-xl font-bold">Affected Disease:</h1>
            <div className=" p-2 grid grid-cols-12 gap-2  rounded-md">
              <div className="col-span-4 p-4 flex justify-center rounded-lg shadow-md">
                {/* <img src={pl} alt="" className="flex rounded-lg size-auto" /> */}
                <img src={URL.createObjectURL(formdata.image)} alt=""className="flex rounded-lg size-auto" /> 
              </div>
              <div className="col-span-8 p-4 bg-dgry rounded-lg shadow-md">
                <h1 className="text-xl text-gray-200">
                  Predicted Disease:
                  <strong className="text-rup">
                    &nbsp;{data.predicted_disease.disease_name}
                  </strong>
                </h1>
                <p className="text-justify p-6 text-gray-300">
                  {data.predicted_disease.description}
                </p>
                <h2 className="text-gray-300 flex justify-center">Measures:</h2>
                <div className="text-white gap-2 flex flex-col justify-center">
                  {data.measures.map((mes, index) => (
                    <p
                      key={index}
                      className="bg-rup text-black rounded-lg p-2 flex justify-center"
                    >
                      {mes}
                    </p>
                  ))}
            ...
            <div className="grid sm:grid-cols-12 py-2 gap-6">
