    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="http://www.linkedin.com/in/mathana-akash"  target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/nishvanth2003/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
        ...
        <li className="icon-content">
      <a href="https://api.whatsapp.com/send?phone=6374608652&text=Hello, I need to talk about the FarmSol." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" data-social="whatsapp">
        <div className="filled" />
        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16" xmlSpace="preserve">
          <path d="M13.6 2.4A7.98 7.98 0 0 0 8 0a8 8 0 0 0-8 8 7.96 7.96 0 0 0 1.067 4.026L0 16l4.026-1.067A7.96 7.96 0 0 0 8 16a8 8 0 0 0 5.6-13.6zm-5.6 11.2a6.4 6.4 0 0 1-3.307-.892L4 12l-2.133.533L2.4 10l-.508-1.12A6.4 6.4 0 1 1 8 13.6zm3.094-4.093c-.14-.07-.833-.412-.962-.459-.13-.046-.237-.07-.335.07-.098.14-.384.46-.47.557-.086.097-.173.105-.314.035-.14-.07-.592-.218-1.126-.693-.415-.36-.695-.806-.778-.94-.083-.135-.008-.208.062-.274.064-.062.14-.16.21-.24.07-.08.093-.14.14-.236.046-.096.024-.176-.012-.247-.035-.07-.314-.756-.43-1.036-.114-.276-.23-.238-.315-.242-.087-.003-.186-.003-.286-.003s-.26.038-.397.176c-.136.137-.52.505-.52 1.231s.534 1.424.608 1.522c.07.094 1.052 1.69 2.55 2.314.356.154.635.246.853.315.358.113.682.097.94.058.287-.044.833-.34.95-.667.116-.327.116-.606.08-.667-.035-.062-.128-.097-.267-.17z" fill="currentColor" />
        </svg>
      </a>
      <div className="tooltip">WhatsApp</div>
    </li>
        <li className="icon-content">
          <a href="https://youtube.com/@mr-rq4mv?si=s029IOy5KfUYRfGm" target="_blank" rel="noopener noreferrer" aria-label="Youtube" data-social="youtube">
            <div className="filled" />
